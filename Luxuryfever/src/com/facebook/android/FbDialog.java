...
public class FbDialog extends Dialog {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		int[] size = getDialogSize(getContext());
		addContentView(mContent, new LayoutParams(size[0], size[1]));
	}
	...
	private int[] getDialogSize(Context context) {
