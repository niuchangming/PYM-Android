...
public class ProductDisplay extends FragmentActivity implements
	...
	public ArrayList<ProductsDataModel> all_prdt = new ArrayList<ProductsDataModel>();
	public ArrayList<ProductsDataModel> shoes_prdt = new ArrayList<ProductsDataModel>();
	public ArrayList<ProductsDataModel> handbags_prdt = new ArrayList<ProductsDataModel>();
	...
	View _settings_view, _login_view, _mycart_view, mSupportView, _invite_view,
			_logout_view;
	...
	private boolean isFristLoadProducts = true;
	...
	/**
	 * @modify ycb
	 * @date 2015/3/8 User the same Fragment with bundle
	 */
	private void intialiseViewPager() {
		List<Fragment> fragments = new Vector<Fragment>();
		Bundle bundle = new Bundle();
		bundle.putInt(ProductDisplayFragment.DISPLAY_TAG,
				ProductDisplayFragment.ALL);
		fragments.add(Fragment.instantiate(this,
				ProductDisplayFragment.class.getName(), bundle));
		bundle = new Bundle();
		bundle.putInt(ProductDisplayFragment.DISPLAY_TAG,
				ProductDisplayFragment.HAND_BAGS);
		fragments.add(Fragment.instantiate(this,
				ProductDisplayFragment.class.getName(), bundle));
		bundle = new Bundle();
		bundle.putInt(ProductDisplayFragment.DISPLAY_TAG,
				ProductDisplayFragment.SHOES);
		fragments.add(Fragment.instantiate(this,
				ProductDisplayFragment.class.getName(), bundle));
	...
	private void initialiseTabHost(Bundle bundle) {
		...
		ProductDisplay.AddTab(this, this.mTabHost,
				...
				(tabInfo = new TabInfo("Tab1", ProductDisplayFragment.class,
						bundle)));
		...
		ProductDisplay.AddTab(this, this.mTabHost,
				...
				(tabInfo = new TabInfo("Tab2", ProductDisplayFragment.class,
						bundle)));
		this.mapTabInfo.put(tabInfo.tag, tabInfo);
		// bundle = new Bundle();
		// bundle.putInt(ProductDisplayFragment.DISPLAY_TAG,
		...
		ProductDisplay.AddTab(this, this.mTabHost,
				...
				(tabInfo = new TabInfo("Tab3", ProductDisplayFragment.class,
						bundle)));
		this.mapTabInfo.put(tabInfo.tag, tabInfo);
	...
	public void onClick(View v) {
		...
		case R.id.btn_support:
			Intent support = new Intent(ProductDisplay.this,
			...
			if (_responsecode == 200) {
				...
				try {
					...
					for (int i = 0; i < get_campaigns.length(); i++) {
						...
						all_data_model.setTeaser_square_url(teaser_square_url);
						...
						// we choose the product to shoes if there is shoe/heel
						// in the name,
						// others are handbags
						if (name.toLowerCase().contains("shoe")
								|| name.toLowerCase().contains("heel")) {
							// ProductsDataModel shoes_data_model = new
							// ProductsDataModel();
							// shoes_data_model.setEnds_at(ends_at);
							// shoes_data_model.setTeaser_url(teaser_url);
							// shoes_data_model
							// .setTeaser_square_url(teaser_square_url);
							...
							shoes_prdt.add(all_data_model);
						} else {
							// otherwise this is handbag category
							// ProductsDataModel handbags_data_model = new
							// ProductsDataModel();
							...
							// handbags_data_model.setDiscount_text(discount_text);
							// handbags_data_model.setFree_shipping(free_shipping);
							// handbags_data_model.setShipping_fee(shipping_fee);
							// handbags_data_model
							// .setShipping_period(shipping_period);
							// handbags_prdt.add(handbags_data_model);
							handbags_prdt.add(all_data_model);
						}
