...
public class PaymentScreenDataAdapter extends BaseAdapter {
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		// R.layout.payment_layout, parent, false);
		...
		_view = convertView;
		if (_view == null) {
			_view = LayoutInflater.from(_scontext).inflate(
					R.layout.payment_layout_item, parent, false);
		}
