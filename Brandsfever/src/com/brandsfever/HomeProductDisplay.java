...
public class HomeProductDisplay extends Fragment {
	ViewGroup _view;
	ListView home_product_list;
	...
	public View onCreateView(LayoutInflater inflater, ViewGroup container,
		...
		if (a <= 6) {
			_view = (ViewGroup) inflater.inflate(
					R.layout.phone_home_product_display, null);
		} else if (a >= 7 && a < 9) {
			_view = (ViewGroup) inflater.inflate(
					R.layout.seven_inch_home_product_display, null);
		} else if (a >= 9) {
			_view = (ViewGroup) inflater.inflate(
					R.layout.ten_inch_home_product_display, null);
			System.out.println("in ten inch");
		}
		home_product_list = (ListView) _view
		...
		if (a <= 6) {
			_padapter = new PhoneAdapter(ctx, ProductDisplay.home_prdt);
			home_product_list.setAdapter(_padapter);
		} else if (a >= 7) {
			_tadapter = new TabAdapter(ctx, ProductDisplay.home_prdt);
			home_product_list.setAdapter(_tadapter);
		}

		home_product_list.setOnScrollListener(new OnScrollListener() {
			@Override
		...
		_scrollup.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v) {
				home_product_list.setSelection(0);
				_scrollup.setVisibility(View.GONE);
			}
		});
